...
const ImageSearchPage = () => {
  ...
  const [activeTab, setActiveTab] = useState('visualSearch'); // 'extension' or 'visualSearch'
  
  // Replace with your actual links
  const extensionDownloadUrl = "https://drive.google.com/uc?id=1pD8y351CrnXp8RI8gZ6UqoVX8R5wCHZ5";
  ...
  return (
    <div className="min-h-screen pt-36 sm:pt-40 pb-16 bg-[#FAFAFA]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Desktop-only Warning Banner - Only show for extension tab */}
        {activeTab === 'extension' && (
          <motion.div
        ...
        {/* Tab Navigation */}
        <div className="mb-8 border-b border-neutral/10">
          <div className="flex">
            <button
              onClick={() => setActiveTab('extension')}
              className={`px-6 py-4 font-serif text-lg relative ${
                activeTab === 'extension' 
                  ? 'text-primary' 
            ...
            >
              <span className="flex items-center gap-2">
                <RiChromeLine className="text-xl" />
                Browser Extension
              </span>
              {activeTab === 'extension' && (
                <motion.div 
            ...
            <button
              onClick={() => setActiveTab('visualSearch')}
              className={`px-6 py-4 font-serif text-lg relative ${
                activeTab === 'visualSearch' 
                  ? 'text-primary' 
                  : 'text-neutral/60 hover:text-neutral'
              }`}
            >
